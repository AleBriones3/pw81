...
use App\Http\Requests\validadorFromRecuerdos;
use DB;
use Carbon\Carbon;
...
class controllerCrudD extends Controller
{
     ...
     */
    public function store(validadorFromRecuerdos $request)
    {   
     ...
     */
    public function update(validadorFromRecuerdos $request, string $id)
    {
        ...
        return redirect('/recuerdo')->with('confirmacion', 'Tu recuerdo se Modificó en la BD');
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(validadorFromRecuerdos $request, string $id)
    {
