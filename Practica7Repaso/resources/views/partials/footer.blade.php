...
<footer class="text-center text-white" style="background-color: #ffc20b;">
    ...
    © 2020 Copyright:
    <a class="text-white" href="/">BIBLIO-LARAVEL</a>
    <br>
    <a class="text-white" href="/">27 de Octubre de 2023</a>
    </div><!-- Copyright -->
</footer><!-- FIN FOOTER -->
